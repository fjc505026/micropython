...
fileList[0]= "S467_TLCMC_FLSDRV.hex"
fileList[1]= "S467_TLCMC_C002.hex"
fileList[2]= "S467_FP.hex"
fileList[3]= "S467_EOL.hex"
...
def ReflashECU():
    ...
    if (BootLoaderState == Idle):
        ...
        msg = array('B',[2, 0x37, 0XFF, 0 ,0 ,0 ,0 ,0 ])
